...
from predicting.predictor.nn_binary_predictor import StockANnBinaryPredictor,\
    StockBNnBinaryPredictor
from predicting.predictor.nn_perfect_binary_predictor import StockANnPerfectBinaryPredictor,\
