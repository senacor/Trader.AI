...
class PerfectPredictorTest(unittest.TestCase):
    ...
    def testConstructor(self):
        ...
        self.assertEqual(predictorA.stock_values.get(0)[1], 0.05962)
        self.assertEqual(predictorA.stock_values.get_last()[1], 101.610001)
        ...
        self.assertEqual(predictorB.stock_values.get(0)[1], 2.192523)
        self.assertEqual(predictorB.stock_values.get_last()[1], 151.350006)
