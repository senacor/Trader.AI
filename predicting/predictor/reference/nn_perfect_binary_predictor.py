...
if __name__ == "__main__":
    ...
    company_a_stock_data: StockData = training_stock_market_data[CompanyEnum.COMPANY_A]
    ...
    company_b_stock_data: StockData = training_stock_market_data[CompanyEnum.COMPANY_B]
