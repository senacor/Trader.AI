...
class TeamBlueDqlTraderTest(unittest.TestCase):
    ...
    def testTeamBlueDqlTrader(self):
        trader = TeamBlueDqlTrader(PerfectPredictor(CompanyEnum.COMPANY_A), PerfectPredictor(CompanyEnum.COMPANY_B))
...
if __name__ == "__main__":
    suite = unittest.TestLoader().loadTestsFromTestCase(TeamBlueDqlTraderTest)
