...
class TeamBlackSimpleTraderTest(unittest.TestCase):
    ...
    def testSimpleTrader(self):
        trader = TeamBlackSimpleTrader(PerfectPredictor(CompanyEnum.COMPANY_A), PerfectPredictor(CompanyEnum.COMPANY_B))
...
if __name__ == "__main__":
    suite = unittest.TestLoader().loadTestsFromTestCase(TeamBlackSimpleTraderTest)
